...
var poolTreeStore = Ext.create('Ext.data.TreeStore', {
    fields: ['id', 'parentId', 'name', 'sort', 'match', 'action', 'checked'],
    proxy: {
        type: 'ajax',
        // url: '/pool/get',
        api: {
                        ...
                        items: [{
                            ...
                            tbar: [{
                                ...
                                handler: function() {
                                    ...
                                    var model = tree.getSelectionModel().selected.items[0];
                            ...
                            listeners: {
                                ...
                                itemclick: function(aNode, record, item, index, e, eOpts) {
                                    if (record.raw.leaf) {
                                        Ext.getCmp('poolAdd').setDisabled(false);
                                        Ext.getCmp('poolRemove').setDisabled(false);
                                        Ext.getCmp('poolEdit').setDisabled(false);
                                    } else {
                                        Ext.getCmp('poolAdd').setDisabled(true);
                                        Ext.getCmp('poolRemove').setDisabled(true);
                                        Ext.getCmp('poolEdit').setDisabled(true);
                                    }
                                }
                            }
                        }]
